...
import { saveContractorReview } from
  "@/features/reviews/actions/save-contractor-review";
...
export function ContractorReviewForm({
  ...
  function handleSubmit() {
    if (
      ...
      setErrorMessage(
        "Поставьте общую оценку подрядчику"
      );
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Расскажите о качестве работы, соблюдении сроков и взаимодействии с подрядчиком..."
        />
