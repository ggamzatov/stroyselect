        ...
        <div className="sticky top-24 overflow-hidden rounded-[1.75rem] border border-border bg-card shadow-[var(--shadow-soft)]">
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={[
                    "group flex min-h-12 items-center gap-3 rounded-2xl px-4 text-sm font-semibold transition",
                    active
                      ? "bg-primary text-primary-foreground shadow-[0_10px_24px_rgba(107,70,50,0.16)]"
          ...
          <div className="border-t border-border p-4">
            <div className="rounded-2xl bg-secondary/60 p-4">
              <p className="text-xs font-semibold text-primary">СтройВыбор</p>
        ...
        {navigation.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={[
                "inline-flex min-h-10 shrink-0 items-center gap-2 rounded-xl px-3 text-xs font-semibold transition",
                active
