...
ALTER TABLE ONLY "public"."contractor_portfolio_files"
    ADD CONSTRAINT "contractor_portfolio_files_uploaded_by_fkey" FOREIGN KEY ("uploaded_by") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."contractor_reviews"
    ADD CONSTRAINT "contractor_reviews_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Anyone can read verified contractor companies" ON "public"."contractor_companies" FOR SELECT TO "authenticated", "anon" USING ((("verification_status" = 'verified'::"public"."contractor_verification_status") OR ("owner_id" = "auth"."uid"())));
...
CREATE POLICY "Anyone can read verified contractor service areas" ON "public"."contractor_service_areas" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
  ...
  WHERE (("contractor_companies"."id" = "contractor_service_areas"."contractor_id") AND (("contractor_companies"."verification_status" = 'verified'::"public"."contractor_verification_status") OR ("contractor_companies"."owner_id" = "auth"."uid"()))))));
...
CREATE POLICY "Anyone can read verified contractor services" ON "public"."contractor_services" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "contractor_services"."contractor_id") AND (("contractor_companies"."verification_status" = 'verified'::"public"."contractor_verification_status") OR ("contractor_companies"."owner_id" = "auth"."uid"()))))));



CREATE POLICY "Contractors can create own company" ON "public"."contractor_companies" FOR INSERT TO "authenticated" WITH CHECK ((("owner_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'contractor'::"public"."user_role") AND ("profiles"."is_blocked" = false))))));



CREATE POLICY "Contractors can update own company" ON "public"."contractor_companies" FOR UPDATE TO "authenticated" USING (("owner_id" = "auth"."uid"())) WITH CHECK (("owner_id" = "auth"."uid"()));
...
CREATE POLICY "Contractors manage own service areas" ON "public"."contractor_service_areas" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "contractor_service_areas"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "contractor_service_areas"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Contractors manage own services" ON "public"."contractor_services" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "contractor_services"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "contractor_services"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Contractors read own bids" ON "public"."project_bids" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "project_bids"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Contractors read own company" ON "public"."contractor_companies" FOR SELECT TO "authenticated" USING (("owner_id" = "auth"."uid"()));
...
CREATE POLICY "Contractors update own active bids" ON "public"."project_bids" FOR UPDATE TO "authenticated" USING ((("status" = ANY (ARRAY['submitted'::"public"."bid_status", 'viewed'::"public"."bid_status", 'shortlisted'::"public"."bid_status"])) AND (EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "project_bids"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"())))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "project_bids"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Customers can create own projects" ON "public"."projects" FOR INSERT TO "authenticated" WITH CHECK ((("customer_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'customer'::"public"."user_role") AND ("profiles"."is_blocked" = false))))));



CREATE POLICY "Customers can delete own draft projects" ON "public"."projects" FOR DELETE TO "authenticated" USING ((("customer_id" = "auth"."uid"()) AND ("status" = 'draft'::"public"."project_status")));



CREATE POLICY "Customers can read own projects" ON "public"."projects" FOR SELECT TO "authenticated" USING (("customer_id" = "auth"."uid"()));



CREATE POLICY "Customers can update editable own projects" ON "public"."projects" FOR UPDATE TO "authenticated" USING ((("customer_id" = "auth"."uid"()) AND ("status" = ANY (ARRAY['draft'::"public"."project_status", 'submitted'::"public"."project_status", 'needs_clarification'::"public"."project_status"])))) WITH CHECK (("customer_id" = "auth"."uid"()));



CREATE POLICY "Customers create own projects" ON "public"."projects" FOR INSERT TO "authenticated" WITH CHECK ((("customer_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'customer'::"public"."user_role") AND ("profiles"."is_blocked" = false))))));



CREATE POLICY "Customers delete own drafts" ON "public"."projects" FOR DELETE TO "authenticated" USING ((("customer_id" = "auth"."uid"()) AND ("status" = 'draft'::"public"."project_status")));



CREATE POLICY "Customers manage own project images" ON "public"."project_images" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."projects"
  WHERE (("projects"."id" = "project_images"."project_id") AND ("projects"."customer_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."projects"
  WHERE (("projects"."id" = "project_images"."project_id") AND ("projects"."customer_id" = "auth"."uid"())))));
...
CREATE POLICY "Customers read bids for own projects" ON "public"."project_bids" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."projects"
  WHERE (("projects"."id" = "project_bids"."project_id") AND ("projects"."customer_id" = "auth"."uid"())))));



CREATE POLICY "Customers read own projects" ON "public"."projects" FOR SELECT TO "authenticated" USING (("customer_id" = "auth"."uid"()));
...
CREATE POLICY "Customers update bids for own projects" ON "public"."project_bids" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."projects"
  WHERE (("projects"."id" = "project_bids"."project_id") AND ("projects"."customer_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."projects"
  WHERE (("projects"."id" = "project_bids"."project_id") AND ("projects"."customer_id" = "auth"."uid"())))));



CREATE POLICY "Customers update own projects" ON "public"."projects" FOR UPDATE TO "authenticated" USING (("customer_id" = "auth"."uid"())) WITH CHECK (("customer_id" = "auth"."uid"()));



CREATE POLICY "Selected contractor creates stage files" ON "public"."project_stage_files" FOR INSERT TO "authenticated" WITH CHECK ((("uploaded_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM (("public"."projects" "p"
     JOIN "public"."contractor_companies" "c" ON (("c"."id" = "p"."selected_contractor_id")))
     JOIN "public"."project_stages" "s" ON (("s"."project_id" = "p"."id")))
  WHERE (("p"."id" = "project_stage_files"."project_id") AND ("s"."id" = "project_stage_files"."stage_id") AND ("c"."owner_id" = "auth"."uid"()) AND ("p"."status" = ANY (ARRAY['contractor_selected'::"public"."project_status", 'in_progress'::"public"."project_status"])) AND ("s"."status" = ANY (ARRAY['planned'::"public"."project_stage_status", 'in_progress'::"public"."project_stage_status", 'revision_required'::"public"."project_stage_status", 'awaiting_review'::"public"."project_stage_status"])))))));
...
CREATE POLICY "Selected contractor reads assigned projects" ON "public"."projects" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies" "c"
  WHERE (("c"."id" = "projects"."selected_contractor_id") AND ("c"."owner_id" = "auth"."uid"())))));
...
CREATE POLICY "Selected contractor updates assigned project" ON "public"."projects" FOR UPDATE TO "authenticated" USING (("selected_contractor_id" IN ( SELECT "contractor_companies"."id"
   FROM "public"."contractor_companies"
  WHERE ("contractor_companies"."owner_id" = "auth"."uid"())))) WITH CHECK (("selected_contractor_id" IN ( SELECT "contractor_companies"."id"
   FROM "public"."contractor_companies"
  WHERE ("contractor_companies"."owner_id" = "auth"."uid"()))));
...
CREATE POLICY "Selected contractor updates project stages" ON "public"."project_stages" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."projects" "p"
     JOIN "public"."contractor_companies" "c" ON (("c"."id" = "p"."selected_contractor_id")))
  WHERE (("p"."id" = "project_stages"."project_id") AND ("c"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."projects" "p"
     JOIN "public"."contractor_companies" "c" ON (("c"."id" = "p"."selected_contractor_id")))
  WHERE (("p"."id" = "project_stages"."project_id") AND ("c"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Selected contractors create project stages" ON "public"."project_stages" FOR INSERT TO "authenticated" WITH CHECK ((("created_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM ("public"."projects" "p"
     JOIN "public"."contractor_companies" "c" ON (("c"."id" = "p"."selected_contractor_id")))
  WHERE (("p"."id" = "project_stages"."project_id") AND ("c"."owner_id" = "auth"."uid"()) AND ("p"."status" = ANY (ARRAY['contractor_selected'::"public"."project_status", 'in_progress'::"public"."project_status"])))))));
...
CREATE POLICY "Staff can create admin audit logs" ON "public"."admin_audit_logs" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_staff_user"() AND ("admin_id" = "auth"."uid"())));



CREATE POLICY "Staff can create verification logs" ON "public"."contractor_verification_logs" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_staff_user"() AND ("admin_id" = "auth"."uid"())));
...
CREATE POLICY "Uploaders delete own message files" ON "public"."project_message_files" FOR DELETE TO "authenticated" USING ((("uploaded_by" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id")));



CREATE POLICY "Uploaders delete own stage files" ON "public"."project_stage_files" FOR DELETE TO "authenticated" USING ((("uploaded_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
...
CREATE POLICY "Users create own chat state" ON "public"."project_chat_reads" FOR INSERT TO "authenticated" WITH CHECK ((("user_id" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id")));



CREATE POLICY "Users delete own messages" ON "public"."project_messages" FOR DELETE TO "authenticated" USING ((("sender_id" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id")));
...
CREATE POLICY "Users update own chat state" ON "public"."project_chat_reads" FOR UPDATE TO "authenticated" USING ((("user_id" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id"))) WITH CHECK ((("user_id" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id")));



CREATE POLICY "Users update own messages" ON "public"."project_messages" FOR UPDATE TO "authenticated" USING ((("sender_id" = "auth"."uid"()) AND ("is_deleted" = false) AND "public"."can_access_project_workspace"("project_id"))) WITH CHECK ((("sender_id" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id")));
...
CREATE POLICY "Verified contractors create bids" ON "public"."project_bids" FOR INSERT TO "authenticated" WITH CHECK (((EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."id" = "project_bids"."contractor_id") AND ("contractor_companies"."owner_id" = "auth"."uid"()) AND ("contractor_companies"."verification_status" = 'verified'::"public"."contractor_verification_status") AND ("contractor_companies"."accepts_new_projects" = true)))) AND (EXISTS ( SELECT 1
   FROM "public"."projects"
...
CREATE POLICY "Verified contractors read published projects" ON "public"."projects" FOR SELECT TO "authenticated" USING ((("status" = ANY (ARRAY['published'::"public"."project_status", 'collecting_bids'::"public"."project_status"])) AND (EXISTS ( SELECT 1
   FROM "public"."contractor_companies"
  WHERE (("contractor_companies"."owner_id" = "auth"."uid"()) AND ("contractor_companies"."verification_status" = 'verified'::"public"."contractor_verification_status") AND ("contractor_companies"."accepts_new_projects" = true))))));



CREATE POLICY "Workspace participants create message files" ON "public"."project_message_files" FOR INSERT TO "authenticated" WITH CHECK ((("uploaded_by" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id") AND (EXISTS ( SELECT 1
   FROM "public"."project_messages" "pm"
  WHERE (("pm"."id" = "project_message_files"."message_id") AND ("pm"."project_id" = "project_message_files"."project_id") AND ("pm"."sender_id" = "auth"."uid"()))))));



CREATE POLICY "Workspace participants create project events" ON "public"."project_events" FOR INSERT TO "authenticated" WITH CHECK ((("author_id" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id")));
...
CREATE POLICY "Workspace participants send messages" ON "public"."project_messages" FOR INSERT TO "authenticated" WITH CHECK ((("sender_id" = "auth"."uid"()) AND "public"."can_access_project_workspace"("project_id")));
...
CREATE POLICY "customer creates completed project review" ON "public"."contractor_reviews" FOR INSERT TO "authenticated" WITH CHECK ((("customer_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."projects" "p"
  WHERE (("p"."id" = "contractor_reviews"."project_id") AND ("p"."customer_id" = "auth"."uid"()) AND ("p"."status" = 'completed'::"public"."project_status") AND ("p"."selected_contractor_id" = "contractor_reviews"."contractor_id"))))));



CREATE POLICY "customer deletes own review" ON "public"."contractor_reviews" FOR DELETE TO "authenticated" USING (("customer_id" = "auth"."uid"()));



CREATE POLICY "customer updates own review" ON "public"."contractor_reviews" FOR UPDATE TO "authenticated" USING (("customer_id" = "auth"."uid"())) WITH CHECK ((("customer_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."projects" "p"
  WHERE (("p"."id" = "contractor_reviews"."project_id") AND ("p"."customer_id" = "auth"."uid"()) AND ("p"."status" = 'completed'::"public"."project_status") AND ("p"."selected_contractor_id" = "contractor_reviews"."contractor_id"))))));
...
CREATE POLICY "portfolio files delete own" ON "public"."contractor_portfolio_files" FOR DELETE TO "authenticated" USING ((("uploaded_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM ("public"."contractor_portfolio_projects" "cpp"
     JOIN "public"."contractor_companies" "cc" ON (("cc"."id" = "cpp"."contractor_id")))
  WHERE (("cpp"."id" = "contractor_portfolio_files"."portfolio_project_id") AND ("cc"."owner_id" = "auth"."uid"()))))));



CREATE POLICY "portfolio files insert own" ON "public"."contractor_portfolio_files" FOR INSERT TO "authenticated" WITH CHECK ((("uploaded_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM ("public"."contractor_portfolio_projects" "cpp"
     JOIN "public"."contractor_companies" "cc" ON (("cc"."id" = "cpp"."contractor_id")))
  WHERE (("cpp"."id" = "contractor_portfolio_files"."portfolio_project_id") AND ("cc"."owner_id" = "auth"."uid"()))))));
...
CREATE POLICY "portfolio files update own" ON "public"."contractor_portfolio_files" FOR UPDATE TO "authenticated" USING ((("uploaded_by" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM ("public"."contractor_portfolio_projects" "cpp"
     JOIN "public"."contractor_companies" "cc" ON (("cc"."id" = "cpp"."contractor_id")))
  WHERE (("cpp"."id" = "contractor_portfolio_files"."portfolio_project_id") AND ("cc"."owner_id" = "auth"."uid"())))))) WITH CHECK (("uploaded_by" = "auth"."uid"()));
...
CREATE POLICY "portfolio projects delete own" ON "public"."contractor_portfolio_projects" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
  ...
  WHERE (("cc"."id" = "contractor_portfolio_projects"."contractor_id") AND ("cc"."owner_id" = "auth"."uid"())))));
...
CREATE POLICY "portfolio projects update own" ON "public"."contractor_portfolio_projects" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies" "cc"
  WHERE (("cc"."id" = "contractor_portfolio_projects"."contractor_id") AND ("cc"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."contractor_companies" "cc"
  WHERE (("cc"."id" = "contractor_portfolio_projects"."contractor_id") AND ("cc"."owner_id" = "auth"."uid"())))));
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."project_chat_reads";
