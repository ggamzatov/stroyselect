                  ...
                  <div className="flex min-h-[520px] w-full min-w-0 flex-col p-6 md:p-7">
                    <div className="flex min-w-0 items-start gap-4">
                      ...
                      <div className="flex shrink-0 flex-col items-end gap-2">
                        <div className="inline-flex min-h-11 items-center gap-2 whitespace-nowrap rounded-2xl border border-primary/10 bg-secondary px-3.5 py-2 shadow-sm">
                          <Sparkles className="h-4 w-4 shrink-0 text-primary" />
                          <span className="text-xs font-semibold text-muted-foreground">Совпадение</span>
                          <span className="text-lg font-black leading-none tracking-[-0.03em] text-primary">{Math.round(project.match_score)}%</span>
                        </div>
                        {myBid && <span className="inline-flex items-center justify-center gap-1 rounded-full bg-emerald-50 px-2.5 py-1.5 text-[10px] font-semibold leading-4 text-emerald-700"><BadgeCheck className="h-3.5 w-3.5 shrink-0" />Отклик отправлен</span>}
                      </div>
                    </div>
