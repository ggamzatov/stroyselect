      ...
      <div className="app-container max-w-5xl py-8 md:py-12">
        ...
        <section className="mt-5 rounded-[2rem] border border-border bg-card p-6 shadow-[var(--shadow-soft)] md:p-8">
          <div className="flex items-start justify-between gap-5">
            <div><p className="text-sm font-semibold text-primary">Проверка компании</p><h1 className="mt-2 text-3xl font-black tracking-tight">Документы и сведения для проверки</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">Здесь отображаются сведения и документы, которые используются при проверке профиля. Следите за статусом и сроком действия загруженных документов.</p></div>
