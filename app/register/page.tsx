      ...
      <div className="grid min-h-screen lg:grid-cols-[1fr_600px]">
        <section className="relative hidden overflow-hidden bg-primary p-10 text-primary-foreground lg:flex lg:flex-col lg:justify-between xl:p-14">
          ...
          <div className="relative max-w-xl">
            ...
            <h1 className="mt-7 text-5xl font-black leading-[1.05] tracking-[-0.055em] xl:text-6xl">Создайте аккаунт и начните работать со строительными проектами</h1>
            <p className="mt-6 max-w-lg text-base leading-8 text-primary-foreground/70">Выберите свою роль, создайте профиль и получите доступ к инструментам платформы.</p>
          ...
          <div className="relative">
            ...
            <p className="mt-2 text-xs text-primary-foreground/35">Строительство начинается с правильного выбора</p>
          </div>
        </section>
        ...
        <section className="relative flex min-h-screen items-center justify-center px-5 py-10 sm:px-8 lg:px-12">
          ...
          <div className="relative w-full max-w-lg">
            ...
            <div className="mt-8 lg:mt-12">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary text-primary"><UserRoundPlus className="h-5 w-5" /></div>
              <p className="mt-6 text-sm font-semibold text-primary">Новый аккаунт</p>
              <h1 className="mt-2 text-3xl font-black tracking-[-0.04em] text-foreground sm:text-4xl">Регистрация</h1>
              <p className="mt-3 text-sm leading-6 text-muted-foreground">Выберите роль и заполните основные данные. После регистрации вы попадёте в соответствующий личный кабинет.</p>
            </div>
            ...
            <div className="mt-8 border-t border-border pt-6">
              <p className="text-center text-sm text-muted-foreground">
                ...
                <Link href="/login" className="font-semibold text-primary transition hover:underline">Войти</Link>
              </p>
            </div>

            <p className="mt-8 text-center text-xs leading-5 text-muted-foreground/70">Создавая аккаунт, вы соглашаетесь с правилами использования платформы.</p>
          </div>
        </section>
      </div>
    </main>
...
function Feature({ text }: { text: string }) {
  return (
    <div className="flex items-start gap-3 text-sm text-primary-foreground/85">
      <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/10"><CheckCircle2 className="h-4 w-4" /></span>
