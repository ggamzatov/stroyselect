      ...
      <div className="grid min-h-screen lg:grid-cols-[minmax(0,1fr)_620px]">
        <section className="relative hidden overflow-hidden bg-primary p-10 text-primary-foreground lg:flex lg:flex-col lg:justify-between xl:p-14">
          ...
          <div className="relative max-w-2xl">
            ...
            <h1 className="mt-7 text-5xl font-black leading-[1.03] tracking-[-0.055em] xl:text-6xl">
              Начните с задачи или подключите свою компанию
            </h1>
            <p className="mt-6 max-w-xl text-base leading-8 text-primary-foreground/72">
              После регистрации StroySelect покажет именно те инструменты, которые нужны вашей роли: заказчику или подрядчику.
            </p>
          ...
          <div className="relative">
            <p className="text-sm font-semibold text-primary-foreground/55">StroySelect</p>
            <p className="mt-1 text-xs text-primary-foreground/35">Для заказчиков и подрядчиков</p>
          </div>
        </section>
        ...
        <section className="relative flex min-h-screen items-center justify-center px-5 py-8 sm:px-8 lg:px-12">
          ...
          <div className="relative w-full max-w-lg">
            <div className="flex items-center justify-between gap-4">
              <Link href="/" className="inline-flex min-h-10 items-center gap-2 rounded-xl px-1 text-sm font-semibold text-muted-foreground transition hover:text-primary">
            ...
            <div className="mt-8 lg:mt-12">
              ...
              <p className="mt-3 max-w-md text-sm leading-6 text-muted-foreground">
                Выберите роль и заполните основные данные. После регистрации вы попадёте в соответствующий кабинет.
              </p>
            </div>

            <div className="mt-7 rounded-[1.5rem] border border-border bg-card p-4 shadow-[var(--shadow-soft)] sm:p-5">
              <RegisterForm />
            </div>
            ...
            <p className="mt-7 text-center text-xs leading-5 text-muted-foreground/70">
              Создавая аккаунт, вы соглашаетесь с правилами использования платформы.
            </p>
          </div>
        </section>
      </div>
