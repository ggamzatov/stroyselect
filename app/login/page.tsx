...
export const metadata: Metadata = {
  title: "Вход | StroySelect",
};

export default function LoginPage() {
  return (
    <main className="min-h-screen bg-background">
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_560px]">
        <section className="relative hidden overflow-hidden bg-primary p-10 text-primary-foreground lg:flex lg:flex-col lg:justify-between xl:p-14">
          ...
          <Link href="/" className="relative text-2xl font-black tracking-[-0.045em]">
            StroySelect
          </Link>
          ...
          <div className="relative max-w-xl">
            ...
            <h1 className="mt-7 text-5xl font-black leading-[1.05] tracking-[-0.055em] xl:text-6xl">
              Все договорённости и этапы проекта — в одном месте
            </h1>
            <p className="mt-6 max-w-lg text-base leading-8 text-primary-foreground/70">
              Проекты, предложения подрядчиков, этапы, документы, фотографии и чат — без разрозненных переписок.
            </p>
            <div className="mt-9 space-y-4">
              <Feature text="Сравнивайте предложения" />
              <Feature text="Контролируйте этапы работ" />
              <Feature text="Храните документы и фотографии" />
              <Feature text="Фиксируйте договорённости в чате" />
            </div>
          </div>

          <div className="relative">
            <p className="text-sm text-primary-foreground/50">StroySelect</p>
        ...
        <section className="relative flex min-h-screen items-center justify-center px-5 py-10 sm:px-8 lg:px-12">
          ...
          <div className="relative w-full max-w-md">
            ...
            <div className="mt-10 lg:hidden">
              <Link href="/" className="text-2xl font-black tracking-[-0.045em] text-foreground">
                StroySelect
              </Link>
            </div>
            ...
            <p className="mt-8 text-center text-xs leading-5 text-muted-foreground/70">
              Продолжая работу с сервисом, вы соглашаетесь с правилами использования платформы.
            </p>
          </div>
        </section>
      </div>
