          ...
          <div className="relative flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-3xl font-bold tracking-[-0.035em] text-foreground md:text-4xl">
                Сформировать бриф проекта
              </h1>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground md:text-base">
                Форма подстраивается под выбранную услугу и спрашивает только то, что действительно
                нужно для этой категории. Черновик сохраняется по ходу заполнения и используется для
                более точного подбора исполнителей.
              </p>
            </div>
          </div>
        </section>
