          ...
          <div className="relative flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-3xl font-bold tracking-[-0.035em] text-foreground md:text-4xl">
                Сформировать строительный бриф
              </h1>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground md:text-base">
                Четыре коротких шага помогут описать объект, объём работ, готовность документации,
                бюджет и сроки. Черновик сохраняется по ходу заполнения и затем используется для
                более точного подбора подрядчиков.
              </p>
            </div>
          </div>
        </section>
