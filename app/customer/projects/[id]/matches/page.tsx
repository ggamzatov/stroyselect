...
function componentLabel(key:keyof MatchScoreComponents) { const labels:Record<keyof MatchScoreComponents,string>={category:"Категория",primaryService:"Основная специализация",geography:"География",budget:"Бюджет",relevantExperience:"Опыт в категории",propertyExperience:"Опыт на типе объекта",stroyselectScore:"StroySelect Score",rating:"Рейтинг",response:"Ответы",completion:"Завершение",disputeFree:"Без споров"}; return labels[key]; }
