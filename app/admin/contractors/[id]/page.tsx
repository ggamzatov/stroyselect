...
function InfoRow({
  ...
  return (
    <div className="grid gap-1 border-b border-border pb-4 last:border-0 last:pb-0 md:grid-cols-[220px_minmax(0,1fr)]">
...
function DataCard({
  ...
  return (
    <div className="rounded-[1.3rem] border border-border bg-background/60 p-4">
      <p className="text-xs text-muted-foreground">
        {label}
      </p>
          ...
          {logs.map(
            (log) => (
              <article
                ...
                className="relative rounded-[1.3rem] border border-border bg-background/60 p-4"
              >
