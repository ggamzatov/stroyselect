...
export default async function AdminFinancePage({searchParams}:Props){
  ...
  const message=query.refunded?"Возврат отправлен провайдеру. Финальный статус обновится автоматически по webhook.":query.payout?"Выплата отправлена провайдеру. Финальный статус обновится автоматически по webhook.":query.supplier_payout?"Банковский расчёт с поставщиком зафиксирован.":query.error?errorMessage(String(query.error)):null;
